...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final ConstraintLibraryAccessors laccForConstraintLibraryAccessors = new ConstraintLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>constraint</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ConstraintLibraryAccessors getConstraint() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForConstraintLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>leak</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
     ...
     */
    @Deprecated
    public static class ConstraintLibraryAccessors extends SubDependencyFactory {

        public ConstraintLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>layout</b> with <b>androidx.constraintlayout:constraintlayout-compose</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getLayout() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("constraint.layout");
        }
    ...
    public static class DaggerLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>dagger</b> with <b>com.google.dagger:hilt-android</b> coordinates and
    ...
    public static class LeakLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>canary</b> with <b>com.squareup.leakcanary:leakcanary-android</b> coordinates and
         * with version reference <b>leak.canary</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getCanary() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("leak.canary");
        }
    ...
    public static class SocketIoLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>socket.io.client</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final LeakVersionAccessors vaccForLeakVersionAccessors = new LeakVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>crashlytics</b> with value <b>3.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>detekt</b> with value <b>1.22.0-RC1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>ktlint</b> with value <b>11.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>viewbinding</b> with value <b>8.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.leak</b>
         */
        public LeakVersionAccessors getLeak() {
            return vaccForLeakVersionAccessors;
        }
        ...
        /**
         * Group of versions at <b>versions.socket</b>
         */
    ...
    public static class ConstraintVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>constraint.layout</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class FirebaseVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>firebase.bom</b> with value <b>33.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebase.plugin</b> with value <b>4.4.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlugin() { return getVersion("firebase.plugin"); }
    ...
    public static class LeakVersionAccessors extends VersionFactory  {

        public LeakVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>leak.canary</b> with value <b>2.12</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCanary() { return getVersion("leak.canary"); }
    ...
    public static class MaterialVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>material.icons</b> with value <b>1.6.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class NavigationVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>navigation.compose</b> with value <b>2.8.0-beta02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class SocketVersionAccessors extends VersionFactory  {
        ...
        private final SocketIoVersionAccessors vaccForSocketIoVersionAccessors = new SocketIoVersionAccessors(providers, config);
        public SocketVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.socket.io</b>
         */
        public SocketIoVersionAccessors getIo() {
            return vaccForSocketIoVersionAccessors;
        }

    }

    public static class SocketIoVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public SocketIoVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>socket.io</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("socket.io"); }

        /**
         * Version alias <b>socket.io.client</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getClient() { return getVersion("socket.io.client"); }
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>networking</b> which contains the following dependencies:
         * <ul>
    ...
    public static class PluginAccessors extends PluginFactory {
         ...
         * with version reference <b>firebase.plugin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        ...
        /**
         * Plugin provider for <b>serializable</b> with plugin id <b>org.jetbrains.kotlin.plugin.serialization</b> and
         * with version reference <b>serialization</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getSerializable() { return createPlugin("serializable"); }
    ...
    public static class DaggerHiltAndroidPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>dagger.hilt.android.plugin</b> with plugin id <b>com.google.dagger.hilt.android</b> and
         * with version reference <b>dagger</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
    ...
    public static class IoPluginAccessors extends PluginFactory {
        ...
        /**
         * Group of plugins at <b>plugins.io.gitlab</b>
         */
        public IoGitlabPluginAccessors getGitlab() {
            return paccForIoGitlabPluginAccessors;
        }
    ...
    public static class IoGitlabPluginAccessors extends PluginFactory {
        ...
        /**
         * Group of plugins at <b>plugins.io.gitlab.arturbosch</b>
         */
        public IoGitlabArturboschPluginAccessors getArturbosch() {
            return paccForIoGitlabArturboschPluginAccessors;
        }
    ...
    public static class IoGitlabArturboschPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>io.gitlab.arturbosch.detekt</b> with plugin id <b>io.gitlab.arturbosch.detekt</b> and
